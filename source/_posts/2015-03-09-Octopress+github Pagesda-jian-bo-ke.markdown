...
由于本人暂时没有买域名，所以本人也不会介绍如何使用自己的域名来做跳转。
...
```
该命令其实是同步用来发布的内容，注意哦，这里同步的是master分支，因为这是发布到github上给其他用户访问的。更多详细请见我再V2EX上的[帖子](http://v2ex.com/t/175120#reply13)。
...
###6.在多台电脑上同步写博客请参考[链接](http://boboshone.com/blog/2013/06/05/write-octopress-blog-on-multiple-machines/)。
需要注意的是，另一台电脑也要安装git和ruby等环境，但octorepress就不用了，因为会从github上克隆下来。

###Good Luck!


####参考文章：
1.http://shengmingzhiqing.com/blog/setup-octopress-with-github-pages.html/